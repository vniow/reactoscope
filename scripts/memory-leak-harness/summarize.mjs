...
console.log('\nScene Input AudioWorklet (audio thread — invisible elsewhere):');
...
console.log('\nWaveform Capture AudioWorklet (liveness check — see issue #6/#8):');
delta('waveformCaptureWorkletStats.processCallCount', 'process() calls');
delta('waveformCaptureWorkletStats.flushCount', 'SAB frame flushes');
console.log();
