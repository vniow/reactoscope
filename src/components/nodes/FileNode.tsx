  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <div className={`mb-3 text-lg font-medium text-center bg-clip-text text-transparent bg-gradient-to-r ${colors.gradient}`}>
      ...
      >
        ...
        {isDragging && (
          <div className="absolute inset-0 opacity-20 dark:opacity-10 animate-pulse">
            <div className={`absolute inset-0 bg-gradient-to-r ${colors.gradient} blur-xl`}></div>
          </div>
        )}
        ...
        {selectedFile ? (
          ...
          <div className="relative z-10">
            ...
            <div className="relative">
              <button className={`px-3 py-1 text-sm bg-gradient-to-r ${colors.gradient} ${colors.hover} text-white rounded-md transition-all shadow-sm hover:shadow-md`}>
                Select File
              </button>
              <input
                type="file"
