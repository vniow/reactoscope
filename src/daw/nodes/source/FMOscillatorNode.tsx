		...
		>
			...
			>
				...
				<Box className='nodrag nowheel' sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, justifyContent: 'center' }}>
					...
					<HwArcSlider label='detune'      value={data.detune}          min={-1200} max={1200} step={1}   color={color} onChange={v => setNodeParam(id, { detune: v })}          format={v => String(v)}    unit=''   allowValueEdit allowBoundsEdit />
