				...
				<Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, px: 0.5 }}>
					<Box
						...
						sx={{
							...
							color: isReversed ? color : 'rgba(255,255,255,0.35)',
							border: '1px solid', borderColor: isReversed ? color : 'rgba(255,255,255,0.15)',
							borderRadius: '3px', px: 0.75, py: 0.25, userSelect: 'none',
