...
export function SimpleOscNode({ id }: NodeProps<CustomNode>) {
	...
	return (
		<div className={classes.container}>
			<div className={classes.header}>Simple Oscilloscope</div>
			...
			<div className='flex items-center justify-center text-xs'>
				<div className='oscilloscope-node-accent font-mono'>
					Status: {isConnected ? 'CONNECTED' : 'NO SIGNAL'}
				</div>
			</div>

			<div className={classes.subtitle}>📺 WAVEFORM DISPLAY</div>
